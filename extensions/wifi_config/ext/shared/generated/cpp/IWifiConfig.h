...
//methods
    ...
    virtual void get_EAP_Identity( const rho::String& a, rho::apiGenerator::CMethodResult& oResult) = 0;
...
struct IWifiConfigSingleton
{
//constants


    virtual ~IWifiConfigSingleton(){}
...
struct IWifiConfigFactory
{
    virtual ~IWifiConfigFactory(){}

    virtual IWifiConfigSingleton* getModuleSingleton() = 0;


    virtual IWifiConfig* getModuleByID(const rho::String& strID) = 0;
